...
\newcommand{\myBookTitleSpanish}{Deteccion de objetos 3D mediante metodos de deep learning y fusion temporal de cámara y LiDAR}
\newcommand{\myBookTitleEnglish}{3D object detection using deep learning methods and temporal fusion of camera and LiDAR}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CoAdvisor data
\newcommand{\myCoTutorFullName}{nombreCoTutor}
