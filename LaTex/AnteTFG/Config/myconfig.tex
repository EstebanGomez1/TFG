...
\newcommand{\myBookTitleSpanish}{Deteccion de objetos 3D con metodos deep learning y fusión temporal de cámara y LiDAR}
\newcommand{\myBookTitleEnglish}{3D object detection using deep learning methods and temporal fusion for camera and LiDAR}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Author data
\newcommand{\myAuthorName}{Esteban}
\newcommand{\myAuthorSurname}{Gómez García}
\newcommand{\myAuthorFullName}{\myAuthorName{} \myAuthorSurname{}}
\newcommand{\myAuthorGender}{male} 
\newcommand{\myAuthorEmail}{esteban.gomez@edu.uah.es}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CoAdvisor data
\newcommand{\myCoTutorFullName}{Santiago Montiel Marín}
...
\newcommand{\myThesisProposalDate}{4 de octubre de 2024} % "Anteproyecto" date
